...

{
	...
	xfconf.settings = {
		...
		xfce4-panel = {
			...
			"panels/panel-2/position" = "p=10;x=967;y=1045";
			"panels/panel-2/length" = "1,000000";
			"panels/panel-2/length-adjust" = true;
			"panels/panel-2/size" = 48;
			"panels/panel-2/position-locked" = true;
			"panels/panel-2/plugins-id" = [ 10 ];
			"panels/panel-2/autohide-behavior" = 1;
			"panels/panel-2/enable-struts" = false;
			...
			"plugins/plugin-10" = "dockbarx";
			"plugins/plugin-10/expand" = "true";
			"plugins/plugin-10/offset" = 0;
		};
	};
